...
namespace ONI_MP.UI
{
    public class ChatScreen : KScreen
    {
        ...
        {
            var font = Utils.GetDefaultTMPFont();

            // Panel container
            var panel = CreatePanel("ChatPanel", transform, new Vector2(400, 200), new Vector2(20, 20));
            ...
            inputField = CreateInputField("ChatInput", panel.transform, new Vector2(10, 5), new Vector2(380, 30), font);
        ...
        public TMP_InputField CreateInputField(string name, Transform parent, Vector2 position, Vector2 size, TMP_FontAsset font)
        {
            ...
            rt.offsetMin = new Vector2(10, 10);  // left/right padding
            rt.offsetMax = new Vector2(-10, 40); // height = 30px (10 min, 40 max)

            var bg = go.GetComponent<Image>();
            bg.color = new Color(0.2f, 0.2f, 0.2f, 1f);

            var input = go.GetComponent<TMP_InputField>();
            input.lineType = TMP_InputField.LineType.SingleLine; // Important!
